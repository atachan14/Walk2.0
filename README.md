...
- 初回プレイでは 3×3 のマップから始まり、クリアごとにマップサイズが 1 ずつ拡張されます。日記から特定サイズのマップを指定してプレイすることもできます
...
当初はPlayStoreでの公開を想定していましたが、
審査基準を満たすためのテスト体制を整えることが難しかったことに加え、
ゲームのコアとなる体験そのものに課題があると判断したため、
最終的にはGitHub Releaseで公開する形で一区切りとしました。